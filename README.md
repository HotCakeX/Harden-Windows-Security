...
* Myth-busting: open-source software is not better than commercial software. Unless you are a highly skilled programmer who can understand and verify every line of code in the source, and spends time to personally build the software from the source, and repeats all the aforementioned tasks for each subsequent version, then seeing the source code won't have any effect on you because you aren't able to understand nor verify it. You'd have to trust other people and just take their words for it.
