...
public sealed partial class AllowNewAppsLocalFilesDataGrid : Page, INotifyPropertyChanged
{
	...
	private void ColumnSortingButton_Click(object sender, RoutedEventArgs e)
	{
		...
		AllowNewAppsStart.Instance.LocalFilesFileIdentities = ListViewHelper.SortColumn(selector, SearchBox, SortingDirectionToggle, AllowNewAppsStart.Instance.LocalFilesAllFileIdentities, AllowNewAppsStart.Instance.LocalFilesFileIdentities, FileIdentitiesListView);
	}
