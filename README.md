...
* A few reminders about open source programs:
  - Labeling programs as "open source", "closed source" or "commercial", doesn't signify anything related to security or quality of them. You can view the source code of all programs regardless, using tools such as disassemblers, decompilers and more.
