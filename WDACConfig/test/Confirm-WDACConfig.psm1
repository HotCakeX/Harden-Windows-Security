...
function Confirm-WDACConfig {
    ...
    Param(     
        [Parameter(Mandatory, ParameterSetName = "set1")][switch]$ListActivePolicies,
        [Parameter(Mandatory, ParameterSetName = "set2")][switch]$VerifyWDACStatus,
        [Parameter(Mandatory, ParameterSetName = "set3")][switch]$CheckSmartAppControlStatus,
    ...
    dynamicParam {
        ...
        $paramName = 'OnlySupplementalPolicies'
        $dict.Add(
          $paramName,
          [System.Management.Automation.RuntimeDefinedParameter]::new(
            $paramName,
