...
Function Invoke-TacticalMSIXDeployment {
    <#
    .DESCRIPTION
        This script installs the AppControl Manager MSIX package on the system.
    ...
    .PARAMETER MSIXPath
        Mandatory. The path to the AppControlManager MSIX file
    .PARAMETER SignTool
    ...
    process {
        ...
        $PossibleExistingApp = Get-AppxPackage -Name 'AppControl Manager'
        ...
        [System.String]$InstalledAppLocation = (Get-AppxPackage -Name 'AppControl Manager').InstallLocation
...
[System.String]$MSIX = Get-Item -Path "$ScriptFilePath\MSIXOutput\AppControl Manager*\AppControl Manager*.msix" | Sort-Object -Property LastWriteTime -Descending | Select-Object -First 1
