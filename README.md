...
AppControl Manager is available on [the Microsoft Store](https://apps.microsoft.com/detail/9PNG1JDDTGP8). This is easiest and recommended way to install it. [Click here to open the Store app](ms-windows-store://pdp/?productid=9PNG1JDDTGP8)
