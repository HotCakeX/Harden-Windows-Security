...
* Whenever you want to install a program or app in Windows, first use the Microsoft Store or <a href="https://github.com/microsoft/winget-cli">Winget</a>, if the program or app you are looking for isn't available in there, then download it from its official website. _somebody created a nice web interface for interacting with Winget CLI <a href="https://winstall.app/">here</a>._ using Winget or Microsoft store provides many benefits:
