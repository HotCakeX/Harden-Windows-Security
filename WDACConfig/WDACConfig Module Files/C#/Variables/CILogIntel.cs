...
namespace WDACConfig
{
    ...
    public class CILogIntel
    {
        ...
        public static readonly Dictionary<ushort, string> ReqValSigningLevels = new Dictionary<ushort, string>
        {
        ...
        public static readonly Dictionary<ushort, string> SignatureTypeTable = new Dictionary<ushort, string>
        {
        ...
        public static readonly Dictionary<ushort, string> VerificationErrorTable = new Dictionary<ushort, string>
        {
