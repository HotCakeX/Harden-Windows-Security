...
You can seamlessly edit the value of any loaded policy directly from the UI by double-clicking on it or right-clicking a policy and selecting **Edit**. The editor provides a rigorous, real-time input validation system tailored to the specific Registry Value Type of the policy:
...
<!-- Uncomment once this feature is re-enabled in the app.
...
You can select one or more policies in the list view and then right-click and choose `Export` in order to export them to a JSON file.
