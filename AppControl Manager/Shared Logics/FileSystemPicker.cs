...
namespace WDACConfig
{
    public static class FileSystemPicker
    {
        ...
        /// <param name="filters"></param>
        /// <returns></returns>
        public static List<string>? ShowMultiFilePicker(string title = "Select files", params (string Description, string Extension)[] filters)
        {
            IFileOpenDialog dialog = (IFileOpenDialog)new FileOpenDialog();
            ...
            try
            {
                ...
                for (uint i = 0; i < itemCount; i++)
                {
                    ...
                    filePaths.Add(Marshal.PtrToStringAuto(ppszFilePath)!);
                    Marshal.FreeCoTaskMem(ppszFilePath);
                }
