...
> **Note**
> There are 4 items tagged with **#TopSecurity** that can break functionalities or cause difficulties so this script does NOT enable them by default. press `Control + F` and search for `#TopSecurity` in this page or in the script to find those commands and how to enable them if you want. 
