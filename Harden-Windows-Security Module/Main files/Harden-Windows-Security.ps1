...
💠 Features of this Hardening script:
  ...
  ✅ The module prompts for confirmation before running each hardening category and some sub-categories, so you can selectively run (or don't run) each of them.
