        ...
        private void ApplyFilters()
        {
            ...
            if (!string.IsNullOrWhiteSpace(searchTerm))
            {
                ...
                filteredResults = filteredResults.Where(output =>
                    ...
                    (output.ProductName is not null && output.ProductName.Contains(searchTerm, StringComparison.InvariantCultureIgnoreCase)) ||
                    ...
                    (output.PackageFamilyName is not null && output.PackageFamilyName.Contains(searchTerm, StringComparison.InvariantCultureIgnoreCase)) ||
