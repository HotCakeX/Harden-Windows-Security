...
try {
    if ((Test-Path -Path 'Variable:\Requiredbuild') -eq $false) { New-Variable -Name 'Requiredbuild' -Value '22621.3155' -Option 'Constant' -Scope 'Script' -Description 'Minimum required OS build number' -Force }
